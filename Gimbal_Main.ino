...
/*
 * This implementation must have the following connections to the arduino board
 * 
...
volatile boolean Direction;//the rotation direction  //delete direction

// Global Variables for Timing (State Machine)
unsigned long current;
unsigned long prev;
double Ts = 0.05;                     //Ts is in seconds
...
void loop() {
  ...
  if((current - prev) >= (Ts*1000000.0))
  {
    ...
    //The Current Position will be passed to a PID function
